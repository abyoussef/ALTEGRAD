...
## Import cleaner to clean the data :
from helpers.clean import clean

## Import the methods we want to use :
...
def test(method, test_size = 0.4):
    ## Function to Split training set to training and test set and use the method to test it on the train/test split.
    path_to_data = 'data/'
...
def submission(method):
    ## Function to use method in order to perform prediction on the test set.
    path_to_data = 'data/'
